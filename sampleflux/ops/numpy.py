...
class FourierOp:
    ...
    **Windowing & units.** ``window`` applies a :func:`sampleflux.windows.get_window` taper before the
...
class WindowOp:
    ...
    Multiplies the signal by a :func:`sampleflux.windows.get_window` taper (broadcast along ``axis``)
