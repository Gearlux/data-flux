"""Type-spec system: describe and match the types flowing through a :class:`~sampleflux.sample.Sample`.
...
The model is a small set of frozen value objects (no base class — see SampleFlux "Functional Purity"
